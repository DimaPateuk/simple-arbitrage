...
describe("Arbitrage", function () {
  ...
  it("Calculate Crossed Markets", function () {
    ...
    expect(bestCrossedMarket.volume).toEqual(
      BigNumber.from("208333333333333333")
    );
    expect(bestCrossedMarket.profit).toEqual(
      BigNumber.from("0x012be1d487a428ce")
    );
  });
